...
public class NetWorkDisconnectionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localBroadcastManager = LocalBroadcastManager.getInstance(NetWorkDisconnectionActivity.this);
        intentFilter = new IntentFilter();
        intentFilter.addAction("com.tts.triplebro.arans.networkreceiver");
