                ...
                <View>
                    ...
                    <View style={styles.TitleTextView}>
                        ...
                        <View style={{marginTop: 2, flexDirection: "row"}}>
                            <Text style={{color: "#ff2d5e"}}>${parse.money}</Text><Text
                            style={{color: "#B9B9B9", marginLeft: 10}}>价格已包含关税</Text>
                        </View>
                    </View>
                    <View>
                        <TouchableHighlight
                        ...
                        <View style={styles.GoodDescribeTitle}>
                            ...
                            <Text style={styles.DescribeSay}> Retro-sport Ringer Tee is garment-washed for a soft,
                        ...
                        <View style={styles.GoodDescribeTitle}>
                            ...
                            <View style={{
                                ...
                                <Image style={{height: 20, width: 20, marginRight: 10, resizeMode: "contain"}}
                                       source={require('../imges/country.png')}/>
                                <Text>商品来自德国</Text>
                            </View>
                            <View>
                                <Text style={{
                                    ...
                                    fontWeight: "bold",
                                    color: "#000"
                                }}>一笔运费，乐享各式精品，百家货源！</Text>
                                <Text style={{
                                    fontSize: 12,
                                    marginTop: 10
                                }}>无论您一次向多少间合作店购买几件商品，只需支付一笔运费，即可足不出户乐享全球时尚精品。</Text>
                            </View>
                            <View>
                                <Text style={{
                                    fontSize: 12,
                                    ...
                                    fontWeight: "bold",
                                    color: "#000"
                                }}>14天无理由免费退货（退货含税）</Text>
                                <Text style={{fontSize: 12, marginTop: 10}}>我们提供全球免费退货服务。</Text>
                                <Text
                                    style={{fontSize: 12}}>自您签收之日起，您有14天时间无理由退回商品，我们建议再收到商品的7天内，在您的S&W账户上预约免费的“上门提取退货”服务，以确保退货按时抵达原合作伙伴方。</Text>
